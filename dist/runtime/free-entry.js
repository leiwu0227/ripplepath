...
export function proposeJump(state, proposal, root, resume) {
...
function findEntryById(graph, id) {
    return graph.entries.find((e) => e.id === id) ?? null;
}
export function confirmJump(state, proposalId, decision, root) {
...
export function popFrame(state) {
